...
> perché `identity()` è un metodo, e non una costante `public static`? IN QUANTO DEFINISCE UN COMPORTANMENTO SPECIFICO DELL'INTERFACCIA, GESTENDO PROPRIAMENTE L'INPUT E GENERANDO L'OUTPUT RICHIESTO
